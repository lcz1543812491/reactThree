...
void main()
{
    ...
    // float strength = step(0.01, abs(distance(vec2(vuv.x, vuv.y + sin(vuv.x * 30.0) * 0.1), vec2(0.5)) - 0.25));


//    float strength = step(0.01, abs(distance(
//     vec2(
...
//     vec2(0.5)) - 0.25));
  ...
  //  float strength = atan(vuv.x - 0.5, vuv.y - 0.5) / PI * 2.0 + 0.9;


//    float strength = atan(vuv.x - 0.5, vuv.y - 0.5) / PI * 2.0 + 0.5;

//    strength = mod(strength, 0.3);
